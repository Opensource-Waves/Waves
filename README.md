...
<div align="center">A sleek and minimalistic self-hosted web app for streaming your music library on your local network. Built using Vue, Vite, Python and Nodejs.</div>
